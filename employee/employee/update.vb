...
Public Class update
    ...
    Private Sub update_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Using connection As New SqlConnection(My.Settings.connString)
            Const sql As String = "select UserFullName,UserKataName,UserGender,UserDepart,UserBirth,UserMail,UserTele,UserAddress,UserEdu,UserSpecial,UserImage from employee.UsersData where UserID=@UpdateId"
            Using SqlCommand As New SqlCommand(sql, connection)
                ...
                Try
                    ...
                    While dataReaders.Read()
                        ...
                        If dataReaders(10).ToString <> "" Then
                            PictureBox1.Load(dataReaders(10).ToString)
                            DBImageName = dataReaders(10).ToString
                        End If
